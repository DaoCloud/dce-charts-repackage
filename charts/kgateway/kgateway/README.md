...
| kgateway.controller | object | `{"extraEnv":{},"image":{"pullPolicy":"","registry":"","repository":"kgateway-dev/kgateway","tag":""},"logLevel":"info","podDisruptionBudget":{},"replicaCount":1,"service":{"ports":{"grpc":9977,"health":9093,"metrics":9092},"type":"ClusterIP"},"strategy":{},"xds":{"tls":{"enabled":false}}}` | Configure the kgateway control plane deployment. |
| kgateway.controller.extraEnv | object | `{}` | Add extra environment variables to the controller container. |
| kgateway.controller.image | object | `{"pullPolicy":"","registry":"","repository":"kgateway-dev/kgateway","tag":""}` | Configure the controller container image. |
...
| kgateway.controller.image.repository | string | `"kgateway-dev/kgateway"` | Set the image repository for the controller. |
...
| kgateway.resources | object | `{"limits":{"cpu":"512m","memory":"800Mi"},"requests":{"cpu":"256m","memory":"400Mi"}}` | Configure resource requests and limits for the container, such as 'limits.cpu: 100m' or 'requests.memory: 128Mi'. |
