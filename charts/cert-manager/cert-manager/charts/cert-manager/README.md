...
```bash
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.10.2/cert-manager.crds.yaml
```
...
$ helm install my-release --namespace cert-manager --version v1.10.2 jetstack/cert-manager
```
...
| `webhook.image.tag` | Webhook image tag | `v1.10.2` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.10.2` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.10.2` |
