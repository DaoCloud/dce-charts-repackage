...
|------------|------|---------|
| file://components/operator | dynamo-operator | 1.3.1 |
...
| dynamo-operator.controllerManager.manager.image.tag | string | `"1.3.1"` | Image tag (leave empty to use chart default) |
