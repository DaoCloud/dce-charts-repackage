...
*/}}
{{- define "nvcre-certification-monitor.name" -}}
...
*/}}
{{- define "nvcre-certification-monitor.fullname" -}}
{{- "nvcre-certification-monitor" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "nvcre-certification-monitor.chart" -}}
...
Common labels
*/}}
{{- define "nvcre-certification-monitor.labels" -}}
helm.sh/chart: {{ include "nvcre-certification-monitor.chart" . }}
{{ include "nvcre-certification-monitor.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nvcre-certification-monitor.selectorLabels" -}}
app.kubernetes.io/name: {{ include "nvcre-certification-monitor.name" . }}
...
They are deliberately named nvcre-certification-monitor.* rather than nvsentinel.*:
...
*/}}
{{- define "nvcre-certification-monitor.pcAuth.enabled" -}}
...
{{- define "nvcre-certification-monitor.pcAuth.mountPath" -}}
...
{{- define "nvcre-certification-monitor.pcAuth.tokenPath" -}}
{{- printf "%s/token" (include "nvcre-certification-monitor.pcAuth.mountPath" .) -}}
{{- end -}}

{{- define "nvcre-certification-monitor.pcAuth.volume" -}}
  ...
  projected:
    sources:
      - serviceAccountToken:
          ...
          expirationSeconds: {{ include "nvcre-certification-monitor.pcAuth.expirationSeconds" . }}
          path: token
{{- end -}}

{{- define "nvcre-certification-monitor.pcAuth.volumeMount" -}}
- name: platform-connector-token
  mountPath: {{ include "nvcre-certification-monitor.pcAuth.mountPath" . }}
  readOnly: true
{{- end -}}

{{- define "nvcre-certification-monitor.pcAuth.expirationSeconds" -}}
