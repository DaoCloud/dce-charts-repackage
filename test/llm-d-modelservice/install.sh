...
OCI_REGISTRY_URL="oci://127.0.0.1:30080"
...
helm install llm-d-modelservice ${OCI_REGISTRY_URL}/llm-d-modelservice --version ${VERSION}  ${HELM_MUST_OPTION} --namespace kube-system
