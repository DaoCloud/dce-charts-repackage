...
helm install bmc chart-museum/bmc-operator ${HELM_MUST_OPTION}  --namespace bmc --create-namespace \
    --set clusterAgent.agentYaml.hostNetwork=true \
    --set clusterAgent.feature.enableDhcpServer=false \
    --set clusterAgent.storage.type=hostPath 
