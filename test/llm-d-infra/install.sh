...
KIND_KUBECONFIG=$1
CHART_DIR=$( cd ${CURRENT_DIR_PATH}/../../charts/llm-d-infra/llm-d-infra ; pwd )
...
helm install llm-d-infra "${CHART_DIR}" ${HELM_MUST_OPTION}  --set llm-d-infra.gateway.gatewayParameters.accessLogging=false \
